...
class Vehicle:
    ...
    @staticmethod
    def generate_vehicle_string(index, vehicleClass, randomSeed):
        ...
        if vehicleClass == 'motorcycle':
            ...
            if vehicleClass == 'trailer':
                ...
                if trailerModel == 'TruckTrailerSimple':
                    ...
                    vehicleString += "url [ \"https://raw.githubusercontent.com/cyberbotics/webots/R2023b/projects/vehicles/protos/generic/textures/" + \
